...
#' three digits and store them in a vector.
...
#' whether the input number is an Armstrong number. However, the code should include a 
#' check to make sure the user input is numeric: Task 2 in the assignment guidelines. 
#' Also, make sure to adhere to the style guide set out for this course. 
#' Overall, great work!